...
class TypeChecker {
    static func getTypedPropertyForValue<T: EncodeFromString>(value: Any) -> (
        T?
    ) {
    ...
    func addEventProperties(properties: [String: Any]) {
        properties.forEach { key, value in
            ...
            case BranchConstants.BranchEventProperties.affiliation:
                self.affiliation = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            ...
            case BranchConstants.BranchEventProperties.currency:
                let currencyString: String? =
                    TypeChecker.getTypedPropertyForValue(value: value)
            ...
            case BranchConstants.BranchEventProperties.description:
                self.eventDescription = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            case BranchConstants.BranchEventProperties.searchQuery:
                self.searchQuery = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            default:
                self.customData[key] = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            }
        }
    ...
    func addMetadataProperties(metadata: [String: Any]) {
        metadata.forEach { key, value in
            ...
            case BranchConstants.BranchMetadataProperties.quantity:
                let doubleValue: Double? = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            ...
            case BranchConstants.BranchMetadataProperties.currencyType:
                guard
                    let value: String = TypeChecker.getTypedPropertyForValue(
                        value: value
                    )
                else {
                    break
            ...
            case BranchConstants.BranchMetadataProperties.productName:
                self.productName = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            case BranchConstants.BranchMetadataProperties.productBrand:
                self.productBrand = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            case BranchConstants.BranchMetadataProperties.productCategory:
                ...
                self.productCategory = BNCProductCategory.init(
                    rawValue: value.capitalizingFirstLetter()
                )
            case BranchConstants.BranchMetadataProperties.condition:
                ...
                self.condition = BranchCondition.init(
                    rawValue: value.uppercased()
                )
            case BranchConstants.BranchMetadataProperties.productVariant:
                self.productVariant = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            ...
            case BranchConstants.BranchMetadataProperties.ratingCount:
                guard
                    let intValue: Int = TypeChecker.getTypedPropertyForValue(
                        value: value
                    )
                else {
                    break
            ...
            case BranchConstants.BranchMetadataProperties.addressStreet:
                self.addressStreet = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            case BranchConstants.BranchMetadataProperties.addressCity:
                self.addressCity = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            case BranchConstants.BranchMetadataProperties.addressRegion:
                self.addressRegion = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            case BranchConstants.BranchMetadataProperties.addressCountry:
                self.addressCountry = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            case BranchConstants.BranchMetadataProperties.addressPostalCode:
                self.addressPostalCode = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
...
extension BranchUniversalObject {
    func addProperties(properties: [String: Any]) {
        properties.forEach { key, value in
            switch key {
            case BranchConstants.BranchUniversalObjectProperties
                .canonicalIdentifier:
                self.canonicalIdentifier = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            case BranchConstants.BranchUniversalObjectProperties.canonicalUrl:
                self.canonicalUrl = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            ...
            case BranchConstants.BranchUniversalObjectProperties.description:
                self.contentDescription = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            case BranchConstants.BranchUniversalObjectProperties.imageUrl:
                self.imageUrl = TypeChecker.getTypedPropertyForValue(
                    value: value
                )
            default:
                break
